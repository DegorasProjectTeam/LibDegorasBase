...
#include "LibDegorasBase/Timing/time_utils.h"
// =====================================================================================================================
...
class LIBDPBASE_EXPORT DegorasTime
{

public:

    // Ns precision
    LIBDPBASE_EXPORT DegorasTime(const types::HRTimePointStd& tp)
    {
        // TODO
    }

    // Ns precision.
    LIBDPBASE_EXPORT DegorasTime(const std::chrono::nanoseconds& ns)
    {
        // TODO
    }

    // Ns precision.
    LIBDPBASE_EXPORT DegorasTime(const DegorasTime& dego_time)
    {
    ...
    // Ps precision
    LIBDPBASE_EXPORT static DegorasTime fromModifiedJulianDate(const MJDate& date, const SoD& seconds = 0.0L)
    {

    }

    // Ns
    LIBDPBASE_EXPORT static DegorasTime fromSecsSinceUnixEpoch(long long secs)
    {
        return(types::HRClock::from_time_t(secs));
    }

    // Ns
    LIBDPBASE_EXPORT static DegorasTime fromWin32Ticks(types::Windows32Ticks ticks)
    {
