 ...
 */
LIBDPBASE_EXPORT std::string windowsPathToUnix(const std::string& windows_path, bool rm_drive_letter = false);
 ...
 */
LIBDPBASE_EXPORT std::string unixPathToWindows(const std::string& unix_path, const std::string& drive_letter = "");
...
LIBDPBASE_EXPORT std::string normalizePath(const std::string& path);



LIBDPBASE_EXPORT bool createDirectory(const std::string& path);

LIBDPBASE_EXPORT bool directoryExists(const std::string& path);

LIBDPBASE_EXPORT bool fileExists(const std::string &path);

LIBDPBASE_EXPORT std::string getCurrentDir();

LIBDPBASE_EXPORT std::string getFileName(const std::string& filepath);

// Helper class for counting file line numbres of a file.
class LIBDPBASE_EXPORT DegorasInputFileStream : public std::ifstream
{
public:
