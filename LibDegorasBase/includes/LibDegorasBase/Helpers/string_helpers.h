...
LIBDPBASE_EXPORT std::string toUpper(const std::string& str);

// Transform a string to lower case.
LIBDPBASE_EXPORT std::string toLower(const std::string& str);

// String left trim.
LIBDPBASE_EXPORT std::string ltrim(const std::string& str);

// String right trim.
LIBDPBASE_EXPORT std::string rtrim(const std::string& str);

// String trim.
LIBDPBASE_EXPORT std::string trim(const std::string& str);
 ...
 */
LIBDPBASE_EXPORT std::string rmLastLineBreak(const std::string& str);
 ...
 */
LIBDPBASE_EXPORT std::string generateLoremIpsum(unsigned paragraphs, unsigned sentences, unsigned words);
 ...
 */
LIBDPBASE_EXPORT std::string replaceStr(const std::string& str, const std::string& target, const std::string& repl);
 ...
 */
LIBDPBASE_EXPORT std::string fillStr(const std::string& fillChar, size_t width);
...
// TEMPLATES INCLUDES
// =====================================================================================================================
#include <LibDegorasBase/Helpers/string_helpers.tpp>
// =====================================================================================================================
