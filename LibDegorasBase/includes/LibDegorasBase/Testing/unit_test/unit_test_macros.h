...
// LIBRARY INCLUDES
// =====================================================================================================================
#include <LibDegorasBase/Testing/unit_test/unit_test.h>
...
using dpbase::testing::UnitTestBase;                         \
using dpbase::testing::UnitTest;                             \
...
bool final_res = dpbase::testing::UnitTest::instance().runTests(); \
