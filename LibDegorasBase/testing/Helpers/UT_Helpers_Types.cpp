...
#include <LibDegorasBase/Modules/Mathematics>
#include <LibDegorasBase/Modules/Helpers>
// =====================================================================================================================

// NAMESPACES
// ---------------------------------------------------------------------------------------------------------------------
using dpbase::math::types::NumericStrongType;
using dpbase::helpers::traits::is_strong_integral_v;
using dpbase::helpers::traits::is_strong_floating_v;
// ---------------------------------------------------------------------------------------------------------------------
...
M_START_UNIT_TEST_SESSION("LibDegorasBase Helpers Session")
