...
{
    // Exception result.
    std::string exception_str = "[LibDegorasBase,Timing,iso8601DatetimeToTimePoint] Invalid argument:";
...
{
    // Exception result.
    std::string exception_str = "[LibDegorasBase,Timing,julianDateTimeToTimePoint] "
...
M_START_UNIT_TEST_SESSION("LibDegorasBase Timing Session")
